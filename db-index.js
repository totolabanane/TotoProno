...
// --- Migration douce pour les bases créées avant l'ajout du paiement Stripe ---
try {
...
// --- Migration douce pour la réinitialisation de mot de passe ---
// On ne stocke JAMAIS le token en clair : reset_token_hash est un hash SHA-256
// du token envoyé par email, pour qu'une fuite de la base ne permette pas de
// réinitialiser un compte (même logique qu'un mot de passe).
try {
